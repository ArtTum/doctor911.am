...
$this->title = Yii::t('admin', 'Sub Menus');
            ...
            <div class="mr-auto">
                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <a href="<?= Url::to(['/menu'])?>" class="m-nav__link">
            ...
            <div class="m-portlet__body">
                ...
                <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                            <a href="<?= Url::to(['create', 'id' => $menu->id])?>" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                                <span>
                ...
                <?= DataTables::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            'attribute' => 'Անվանում',
                            'value' => function($model){ return Translate::text($model->getLangHasSubMenus(), 'name'); }
                        ],
                        'url',
                        [
                            'attribute' => 'status',
                    ...
                    'options' => [
                        'data' => [
                            'sortable-widget' => 1,
                            'sortable-url' => \yii\helpers\Url::toRoute(['sorting', 'id' => $menu->id]),
                        ]
                    ],
                ]); ?>
