...
$this->title = Yii::t('admin', 'Doctors');
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value'=>function ($model, $index, $widget){
                                return Html::img("/uploads/doctors/".$model->image, ['width' => 70]);
                            }
                        ],
                        [
                            'label' => 'Անուն Ազգանուն Հայրանուն',
                            'value' => function($model){ return Translate::text($model->getLangHasDoctors(), 'full_name'); }
                        ],
                        'alias',
                        [
                            'attribute' => 'status',
