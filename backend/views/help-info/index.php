...
$this->title = Yii::t('admin', 'Help Infos');
                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">
                            Ինչպես օգտվել մեր ծառայությունների ցանկ
                        </h3>
                    </div>
                </div>
            </div>
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value'=>function ($model, $index, $widget){
                                return Html::img("/uploads/help-info/262-146/".$model->image, ['width' => 70]);
                            }
                        ],
                        'order',
                        [
                            'label' => 'Անվանում',
                            'value' => function($model){ return Translate::text($model->getLangHasHelpInfos(), 'text'); }
                        ],
