                        ...
                        <div class="form-group">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 199px; height: 199px;">
                                    <img data-src="holder.js/100%x100%" alt="100%x100%" src="<?= $model->image ? '/uploads/help-info/262-146/'.$model->image : Yii::$app->params['app'].'/images/fa-camera.png'?>" style="height: 100%; width: 100%; display: block;">
                                </div>
                                <div>
                    ...
                    <div class="m-form__actions m-form__actions--right">
                        <div class="row">
                            <div class="col m--align-left">
                                ...
                                <?= Html::a('Չեղարկել', ['/help-info'], ['class' => 'btn btn-secondary'])?>
                            </div>
