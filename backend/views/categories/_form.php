                        ...
                        <div class="form-group">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 199px; height: 199px;">
                                    <img data-src="holder.js/100%x100%" alt="100%x100%" src="<?= $model->image ? '/uploads/categories/45-45/'.$model->image : Yii::$app->params['app'].'/images/fa-camera.png'?>" style="height: 100%; width: 100%; display: block;">
                                </div>
                                <div>
