        ...
        <div class="col-md-8">
            ...
            <div class="m-portlet m-portlet--space">
                ...
                <div class="m-portlet__body row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 199px; height: 199px;">
                                    <img data-src="holder.js/100%x100%" alt="100%x100%" src="<?= $model->image ? '/uploads/hospitals/'.$model->image : Yii::$app->params['app'].'/images/fa-camera.png'?>" style="width: 100%; display: block;">
                                </div>
                                <div>
                    ...
                    <div class="form-group m-form__group col-12">
                        <?= $form->field($model_type, 'type_id')->checkboxList(
                            $type_data, [
                            'item' =>
                                function ($index, $label, $name, $checked, $value) {
                                    $v = HospitalHasType::findOne(['type_id' => $value, 'hospital_id' => Yii::$app->request->get('id')]);
                                    ...
                                    return Html::checkbox($name, $checked, [
                                        'value' => $value,
                                        'label' => '<label for="type_' . $value . '">' . $label . '</label>',
                                        'labelOptions' => [
                    ...
                    <div class="m-form__actions m-form__actions--right">
                        <div class="row">
                            <div class="col m--align-left">
                                ...
                                <?= Html::a('Չեղարկել', ['/hospitals'], ['class' => 'btn btn-secondary'])?>
                            </div>
                            <?if(!$model->isNewRecord):?>
