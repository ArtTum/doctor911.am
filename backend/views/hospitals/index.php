...
$this->title = Yii::t('admin', 'Hospitals');
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value'=>function ($model, $index, $widget){
                                return Html::img("/uploads/hospitals/".$model->image, ['width' => 70]);
                            }
                        ],
                        [
                            'label' => 'Անվանում',
                            'value' => function($model){ return Translate::text($model->getLangHasHospitals(), 'name'); }
                        ],
                        'alias',
                        [
                            'attribute' => 'status',
