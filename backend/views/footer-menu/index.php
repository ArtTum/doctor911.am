...
$this->title = Yii::t('admin', 'Footer Menus');
            ...
            <div class="m-portlet__body">
                ...
                <?= DataTables::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            'attribute' => 'Անվանում',
                            'value' => function($model){ return Translate::text($model->getLangHasFooterMenus(), 'name'); }
                        ],
                        'url',
                        [
                            'attribute' => 'status',
                        ...
                        [
                            ...
                            'template' => '{sub_menu} {update} {delete}',
                            'buttons' => [
                                'sub_menu' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-list-alt"></span>', 'sub-menu/'.$model->id, [
                                        'title' => Yii::t('admin', 'Sub Menus'),
                                    ]);
                                },
