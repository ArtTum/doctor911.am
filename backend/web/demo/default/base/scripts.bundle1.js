...
$(document).ready(function () {
    ...
    e.fn.mDatatable = function (t) {
                    ...
                    if (0 !== a.jsonData.length) {
                            ...
                            e(a).find(".m-datatable__cell").each(function (t, a) {
                                ...
                                if (void 0 !== i) {
                                    ...
                                    if (void 0 !== i.selector && !1 !== i.selector) {
                                        ...
                                        var r = e("<label/>").addClass("m-checkbox m-checkbox--single").append(e("<input name='checkbox[]'/>").attr("type", "checkbox").attr("value", l).on("click", function () {
                        ...
                        var i = function (t) {
                            ...
                            if (void 0 !== a && void 0 !== a.selector && !1 !== a.selector) {
                                ...
                                var i = e("<label/>").addClass("m-checkbox m-checkbox--single m-checkbox--all").append(e("<input name='checkbox[]' />").attr("type", "checkbox").on("click", function () {
        ...
        translate: {
            records: {processing: "Խնդրում ենք սպասել...", noRecords: "Ոչ մի գրառում չի գտնվել"},
            toolbar: {
                pagination: {
                    items: {
                        default: {
                        ...
                        }, info: "Ցուցադրվում է {{start}} - {{end}} - {{total}} գրառումից"
                    }
                }
            }
        }
